...
func initConfig(cmd *cobra.Command, api *api.API, config *viper.Viper) error {
...
configuration repository.`,
		PersistentPreRunE: func(cmd *cobra.Command, args []string) error {
			return initConfig(cmd, api, config)
		},
	}
	...
	cmd.AddCommand(
		NewCmdVersion(api),
		NewCmdCreateGroup(api),
		NewCmdCreateProject(api),
		NewCmdGrantAccess(api),
		NewCmdEnableMonitoring(api),
	)
